...
import com.ads.gps.planefull.listener.LevelDetector;
import com.ads.gps.planefull.listener.LevelListener;
...
public class LevelScreen extends OtherScreen {
    ...
    public LevelScreen(AppGame appGame) {
        super(appGame);
    ...
    public void show() {
        if (!isShow()) {
            ...
            multiplexer.addProcessor(new LevelDetector(levelListener));
            setShow(true);
        }
    ...
    public void render(float delta) {
        if (Gdx.input.isKeyPressed(Input.Keys.BACK)) {
            if (!isBackFlag()) {
                MainScreen mainScreen = getAppGame().getMainScreen();
